...
### 1. خطای "ValueError: too many values to unpack (expected 19)"
...
### 2. خطای "ImportError: cannot import name 'get_store'"
...
### 5. خطای "TELEGRAM_BOT_TOKEN not set"
