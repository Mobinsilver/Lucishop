...
from main import convert_price_for_user, CACHE
...
• از دکمه بازگشت برای خروج استفاده کنید
    """
...
🕒 **آخرین بروزرسانی**: {asyncio.get_event_loop().time():.0f}
        ...
        keyboard = [[InlineKeyboardButton("🔙 بازگشت به لیست", callback_data="back_to_crypto_list")]]
        reply_markup = InlineKeyboardMarkup(keyboard)
